...
//   const { isLiked, handleLikeStatusChange } = useLikeButton(artist?._id);
//
//   useEffect(() => {
...
//   const [handleLikeStatusChange, setHandleLikeStatusChange] = useState<
...
//         setArtist(artistData);
//
//         const { isLiked, handleLikeStatusChange } = useLikeButton(
//           artistData._id,
//         );
//         setIsLiked(isLiked);
//         setHandleLikeStatusChange(() => handleLikeStatusChange);
//       } catch (error) {
//         console.error(error);
//       }
//     };
