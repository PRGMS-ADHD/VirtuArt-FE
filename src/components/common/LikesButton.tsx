...
const LikesButton: React.FC<LikesButtonProps> = ({ onClick }) => {
  return (
    <button
      type="button"
      className="flex h-[30px] w-[100px] items-center justify-around bg-black text-white shadow-md"
      onClick={onClick}
    >
      <HeartIcon className="mr-2 h-5 w-5" />
      <span className="font-['Helvetica'] text-xs font-normal">1234 K</span>
    </button>
  );
};
